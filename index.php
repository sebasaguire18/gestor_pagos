...
<html>
			...
			<div class="row">
				<div class="col-md-12 text-right gtco-contact">
					<ul class="">
						...
						<li id="btn-abrir-popup"><a href="#" ><i class="ti-user"> </i>Iniciar Sesión</a></li>
					</ul>
				</div>
			</div>
	...
	<header id="gtco-header" class="gtco-cover" role="banner" style="background-image:url(images/image_bg_1.jpg);">
